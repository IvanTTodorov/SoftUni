namespace _01.BinaryTree
{
    ...
    public class BinaryTree<T> : IAbstractBinaryTree<T>
    {
        ...
        public string AsIndentedPreOrder(int indent)
        {
            ...
            this.PreOrferDfs(sb, indent, this);
            return sb.ToString();
        }   
        ...
        private void PreOrferDfs(StringBuilder sb, int indent, IAbstractBinaryTree<T> binaryTree)
        {
            sb.Append(new string(' ', indent)).AppendLine(binaryTree.Value.ToString());
            if (binaryTree.LeftChild != null)
            {
                this.PreOrferDfs(sb, indent + 2, binaryTree.LeftChild);
            }
            if (binaryTree.RightChild != null)
            {
                this.PreOrferDfs(sb, indent + 2, binaryTree.RightChild);
            }
        }
    }
}
